...
export default function SideBar() {
    ...
    const sidebarLinks = [
        ...
        { label: "Plans", icons: <TbReport size={25} color={`${activeLink === "/admin/plans" ? "blue" : "black"}`} />, href: "/admin/plans" },
        { label: "Payments", icons: <MdOutlinePayment size={25} color={`${activeLink === "/admin/payments" ? "blue" : "black"}`} />, href: "/admin/payments" },
        { label: "Routers", icons: <BsFillRouterFill size={25} color={`${activeLink === "/admin/routers" ? "blue" : "black"}`} />, href: "/admin/routers" },
        { label: "Reports", icons: <BiSolidReport size={25} color={`${activeLink === "/admin/reports" ? "blue" : "black"}`} />, href: "/admin/reports" },
        { label: "Tickets", icons: <TiTicket size={25} color={`${activeLink === "/admin/tickets" ? "blue" : "black"}`} />, href: "/admin/tickets" }
