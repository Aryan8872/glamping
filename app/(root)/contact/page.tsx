        ...
        <div className="mt-10 grid gap-6 lg:grid-cols-[1.1fr_.9fr]">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-4">
              {[{ title: "Email", desc: "support@glampinghimalayas.com", icon: "✉" }, { title: "Call", desc: "+1 (800) 555-1234", icon: "☎" }, { title: "Address", desc: "123 Adventure Lane, Suite 100, Boulder, CO 80301", icon: "📍" }, { title: "Working Hours", desc: "Mon–Fri: 9:00 AM – 6:00 PM (PST)", icon: "🗓" }].map((it, i) => (
